...
buffers.push({
    ...
    Shader: new THREE.ShaderMaterial({
        ...
        vertexShader: ${buffer.VertexCode !== undefined ? `prepareVertexShader(document.getElementById('${buffer.Name}_vertex').textContent)` : 'undefined'},
        fragmentShader: prepareFragmentShader(document.getElementById('${buffer.Name}').textContent),
        depthWrite: false,
        depthTest: false,
        uniforms: {
